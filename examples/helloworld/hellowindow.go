...
const TypeHelloWindow = cdk.CTypeTag("hello-window")

func init() {
	_ = cdk.TypesManager.AddType(TypeHelloWindow, nil)
}
...
func (w *HelloWindow) Init() (already bool) {
	if w.InitTypeItem(TypeHelloWindow, w) {
		return true
	}
	w.CWindow.Init()
...
func (w *HelloWindow) draw(data []interface{}, argv ...interface{}) enums.EventFlag {
...
func (w *HelloWindow) event(data []interface{}, argv ...interface{}) enums.EventFlag {
